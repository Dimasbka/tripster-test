"""
Django settings for tripster_app project.
...
SECRET_KEY = "django-insecure-vmwa7uaf05ek%sq4k1w#%)t^hdg2(y=yn_s59tf_4glg51^ds8"
...
WSGI_APPLICATION = "tripster_app.wsgi.application"
...
# отключаю проверку паролей для теста
if not DEBUG:
